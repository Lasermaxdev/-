  ...
  async addPrinter(printerData: Partial<Printer>): Promise<Printer> {
    try {
      ...
      const newPrinter = {
        ...
        // مستويات الحبر
        ink_c: parseInt(String(printerData.ink_c)) || 100,
        ink_m: parseInt(String(printerData.ink_m)) || 100,
        ink_y: parseInt(String(printerData.ink_y)) || 100,
        ink_k: parseInt(String(printerData.ink_k)) || 100,
        ink_bw: parseInt(String(printerData.ink_bw)) || 100,
        ink_note: printerData.ink_note?.trim(),
        
        // مستويات الدرم
        drum_c: parseInt(String(printerData.drum_c)) || 100,
        drum_m: parseInt(String(printerData.drum_m)) || 100,
        drum_y: parseInt(String(printerData.drum_y)) || 100,
        drum_k: parseInt(String(printerData.drum_k)) || 100,
        drum_bw: parseInt(String(printerData.drum_bw)) || 100,
